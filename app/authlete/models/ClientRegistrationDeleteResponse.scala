...
object ClientRegistrationDeleteResponse {
  ...
  given encoderClientRegistrationDeleteResponse: Encoder[ClientRegistrationDeleteResponse] = Encoder
    .instance { t =>
      Json.fromFields {
        Seq(
  ...
  given decoderClientRegistrationDeleteResponse: Decoder[ClientRegistrationDeleteResponse] = Decoder
    .instance { c =>
      for {
