...
/**
  ...
  * @param use
  *   Get the use of the key on the HSM. When the key use is \"sig\" (signature), the private key on
  *   the HSM is used to sign data and the corresponding public key is used to verify the signature.
