...
object AuthorizationFailResponse {
  ...
  given jsonCodec: JsonValueCodec[AuthorizationFailResponse] = JsonCodecMaker.make(codecMakerConfig)

  given encoderAuthorizationFailResponse: Encoder[AuthorizationFailResponse] = Encoder.instance { t =>
    Json.fromFields {
      Seq(
  ...
  given decoderAuthorizationFailResponse: Decoder[AuthorizationFailResponse] = Decoder.instance { c =>
    for {
