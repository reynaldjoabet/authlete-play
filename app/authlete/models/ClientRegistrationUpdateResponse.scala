...
object ClientRegistrationUpdateResponse {
  ...
  given encoderClientRegistrationUpdateResponse: Encoder[ClientRegistrationUpdateResponse] = Encoder
    .instance { t =>
      Json.fromFields {
        Seq(
  ...
  given decoderClientRegistrationUpdateResponse: Decoder[ClientRegistrationUpdateResponse] = Decoder
    .instance { c =>
      for {
